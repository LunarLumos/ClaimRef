...
- ✂️ extracts the **complete claim** surrounding each citation
- 🗂️ resolves the **section hierarchy** it lives in (`Methods > Dataset > Preprocessing`)
...
- 🖨️ renders one clean, branded **Citation Verification Report** PDF
...
| 🅰️ **Author–year styles** | `(Mohanty et al., 2016)`, `Mohanty et al. (2016)` (Springer / Nature / Elsevier / APA) |
...
| | |
|---|---|
| 🏛️ **Section hierarchy** | `Methodology > Dataset > Preprocessing` |
...
| Section | Contents |
|---|---|
| 🏷️ **Cover** | Tool identity, tagline, checker name, timestamp |
...
- [ ] 🕸️ **Citation graph** visualisation
